  ...
  return (
    <div className="Story">
      <div className="row my-5 align-items-center main_story col-10 col-sm-11 offset-sm-0 offset-1">
        <div
          className="col-sm-4 col-12 story_left justify-content-center mx-auto"
          data-aos="fade-right"
          data-aos-delay="100"
        >
        ...
        <div
          className="mt-3 col-12 col-sm-6 story_right justify-content-center align-middle"
          data-aos="fade-left"
          data-aos-delay="200"
        >
          ...
          <p className="text-sm-start text-center">
            ...
            <span className="hidden_p text-sm-start text-center">
              ...
              budget.. we are not here to earn only, we are here to make
              someone's dream event come true.We provide A to Z services related
              any event you are organising to. As per customers requirements we
              serve the best in clients budget.. we are not here to earn only,
              we are here to make someone's dream event come true".
            </span>
          </p>
        </div>
      </div>
