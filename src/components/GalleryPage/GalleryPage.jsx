...
function GalleryPage() {
  return (
    <div className='GalleryPage'>
        ...
        <GalleryPart images={[mundan_1, mundan_2, mundan_3, mundan_4, mundan_5]} name="mundan" text="Mundan Decor" />
        <GalleryPart images={[proposal_1, proposal_2]} name="proposal" text="Proposal" />
        <GalleryPart images={[roomdecor_1, roomdecor_2, roomdecor_3, roomdecor_4]} name="roomdecor" text="Room Decor" />
        </div>
        <Footer />
    </div>
  )
